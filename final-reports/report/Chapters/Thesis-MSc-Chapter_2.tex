...
\caption{A comparison between the analysed optimization plug-ins. S - single, M - multi, G - Global, L - Local.}
...
The tools analysis provides a clear idea of the important features for a better user experience optimization tools and also evidences drawbacks of each one. This thesis tackles some of these obstacles to improve the architectural practice.

All these tools explore visual programming languages, which are easy to learn and use, but often lead to scalability issues and poor legibility of programs. 
