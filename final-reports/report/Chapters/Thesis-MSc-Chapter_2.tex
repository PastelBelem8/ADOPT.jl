...
\label{sec:optimizationalgorithms}
	...
	Optimization algorithms search for the optimal solutions in the solution space. Each algorithm implements different techniques to enhance its search process in the solution space. This variety yields algorithms capable of addressing some type of problems more efficiently than others~\cite{Wolpert1997NFLT}.
