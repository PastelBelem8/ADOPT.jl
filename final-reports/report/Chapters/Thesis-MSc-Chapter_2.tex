...
\label{sec:optimizationalgorithms}
	...
	\begin{itemize}
		...
		\end{itemize}
	\end{itemize}
	When comparing the usefulness of binary indicators, these usually aim at comparing different approximation sets. While the former indicator enables informed comparisons among two different approximation sets, by providing a measure of their relative difference, the latter incorporates utility functions, allowing the user to introduce a preference over the objectives and, consequently, to influence the optimality of each set. 
...
%	\end{figure*}
	...
	%------------------ OPOSSUM ----------------------
	\subsection{Opossum}
	Opossum (OPtimizatiOn Solver with SUrrogate Models) is a generic plug-in, developed on top of Grasshopper, that explores Galapagos' ideas to confer non-programmers an easy way to tackle a wide variety of optimization problems.
