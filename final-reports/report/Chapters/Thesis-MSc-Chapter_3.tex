...
Another important requirement is that at least a subset of the provided algorithms must be tailored to address optimization problems that incorporate time-consuming evaluation functions.%, and for which information is difficult to obtain. 
