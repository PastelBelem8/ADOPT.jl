...
\todo{SALIENTAR IMPORTANCIA DA VISUALIZAÇÃO}
Due to the visual nature of architects and the generalized lack of confidence in optimization's results, the visualization of the evaluated design solutions by the optimization process is of great importance. Therefore, by combining our framework with an \ac{AD} tool, the architect is able to automatically visualize designs explored during the optimization.
