...
\title{Optimization of Time-Consuming Objective Functions}
% OPTIONAL: Thesis SUBTITLE
\subtitle{Derivative-Free Approaches and their Application in Architecture}
%
% -----------------------------------------------------------------------------
% REQUIRED: Author
% Author full Name
...
\vogalone{Prof. Ernesto José Marques Morgado}
