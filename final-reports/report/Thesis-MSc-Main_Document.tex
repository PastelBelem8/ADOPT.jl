...
% -----------------------------------------------------------------------------
%
\documentclass[defaultstyle,10pt]{istulthesis}
%
% -----------------------------------------------------------------------------
...
%
% Add PDF bookmark 
\pdfbookmark[0]{Optimization}{Optimization of Time-Consuming Objective Functions: Derivative-Free Approaches and their Application in Architecture}
...
% -----------------------------------------------------------------------------
\input{./Chapters/Thesis-MSc-Original_Declaration.tex}
\clearpage
% THE ACKNOWLEGMENTS
...
\begin{contributions}
	\input{./Chapters/Thesis-MSc-Publications.tex}
\end{contributions}
...
\pdfbookmark[1]{List of Libraries}{lol}
\begin{listingtools}
	\input{./Chapters/Thesis-MSc-LibrariesListing.tex}
\end{listingtools}
\clearpage
\thispagestyle{empty}
...
%\cleardoublepage
%%% Second Appendix
\pdfbookmark[0]{Appendix B}{appendix}
